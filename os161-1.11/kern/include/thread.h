...
extern struct array *processTable;
...
struct thread {
    ...
    /* This is the process id of the process this thread belongs to */
    
    int pid;
    struct descriptorTable *dt;
 ...
 * Interrupts must be disabled.
 */
void thread_wakeup_first(const void *addr);
