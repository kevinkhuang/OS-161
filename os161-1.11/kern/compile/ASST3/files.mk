...
filedescriptor.o: ${S}/lib/filedescriptor.c
	${COMPILE.c} ${S}/lib/filedescriptor.c
SRCS+=${S}/lib/filedescriptor.c
OBJS+=filedescriptor.o

systemcalls.o: ${S}/userprog/systemcalls.c
	${COMPILE.c} ${S}/userprog/systemcalls.c
SRCS+=${S}/userprog/systemcalls.c
OBJS+=systemcalls.o

exec_v.o: ${S}/userprog/exec_v.c
	${COMPILE.c} ${S}/userprog/exec_v.c
SRCS+=${S}/userprog/exec_v.c
OBJS+=exec_v.o
